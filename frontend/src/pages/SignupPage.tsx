          ...
          <div className="relative flex min-h-[620px] flex-col justify-between">
            <div>
              <div className="flex items-center gap-4">
                ...
                <div>
                  <div className="mt-1 text-xs text-white/55">NCC — National Construction Code of Australia</div>
                </div>
              </div>

              <div className="mt-20 max-w-lg space-y-6">
                <p className="text-[12px] font-semibold uppercase tracking-[0.28em] text-[#f1ddab]">NCC library</p>
                <h2 className="text-4xl font-semibold leading-tight tracking-tight text-white sm:text-5xl">
                  Get started with the National Construction Code of Australia.
                </h2>
                <p className="text-sm leading-7 text-slate-300">
                  Create your account and ask grounded questions over NCC volumes.
                </p>
              </div>
            </div>
        ...
        <section className="flex items-center justify-center bg-white/82 px-6 py-10 sm:px-10">
          <div className="w-full max-w-sm">
            <div className="mb-6">
              ...
              <p className="mt-2 text-sm leading-6 text-slate-500">Set up your account for NCC search and Q&amp;A.</p>
            </div>
